...
Выигрыши представлены в следующей матричной форме (прибыль в млн руб.):

| Компания A / Компания B | Высокая цена | Низкая цена |
|--------------------------|---------------|-------------|
| **Высокая цена**         | (10, 10)      | (2, 15)     |
| **Низкая цена**          | (15, 2)       | (4, 4)      |
